...
class __TwigTemplate_da99ac6eaaf56e0207796893aaf22a88585de6dd597516649698223bb6c0575f extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "</td>
                <td>
                    <a href=\"";
            // line 21
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_categorie_show", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 21)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_categorie_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  129 => 33,  124 => 30,  115 => 26,  106 => 22,  102 => 21,  97 => 19,  93 => 18,  90 => 17,  85 => 16,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
    ...
    <table class=\"table\">
        ...
        {% for category in categories %}
            <tr>
                ...
                <td>{{ category.name }}</td>
                <td>
                    <a href=\"{{ path('app_categorie_show', {'id': category.id}) }}\">show</a>
                    <a href=\"{{ path('app_categorie_edit', {'id': category.id}) }}\">edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
...
{% endblock %}
", "category/index.html.twig", "C:\\Users\\gicke\\PhpstormProjects\\trainingvideos\\templates\\category\\index.html.twig");
    }
}
